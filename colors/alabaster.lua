...
if vim.o.background == "dark" then
    ...
    theme = {
        ...
        ["@attribute"] = { fg = ansi.white },
        ["@comment.documentation"] = { fg = punct_fg },
        ...
        ["@repeat"] = { fg = ansi.white },
        ["@string"] = { fg = string_fg },
        ["@string.regex"] = { bg = "#1d292b", fg = ansi.yellow },
        ["@string.regexp"] = { bg = "#1d292b", fg = ansi.yellow },
        ["@string.escape"] = { bg = "#1d292b", fg = string_fg },
        ["@symbol"] = {},
        ["@type"] = { fg = ansi.white },
        ...
        --- Theme specific
        ["@AlabasterAttention"] = { fg = ansi.yellow },
        ["@AlabasterBase"] = { fg = ansi.white },
        ["@AlabasterConstant"] = { fg = const_fg },
        ["@AlabasterDefinition"] = { fg = def_fg },
        ["@AlabasterKeyword"] = { fg = vim.g.alabaster_keywords and const_fg or ansi.white },
    ...
    theme = {
        ...
        ["@repeat"] = { fg = ansi.black },
        ["@string"] = { fg = string_fg },
        ["@string.regex"] = { bg = bg, fg = ansi.yellow },
        ["@string.regexp"] = { bg = bg, fg = ansi.yellow },
        ["@string.escape"] = { bg = bg, fg = string_fg },
        ["@symbol"] = {},
        ["@type"] = { fg = ansi.black },
